...
def video_upload_view(request):
    ...
    if request.method == "POST":
        ...
        try:
            ...
            # ---- CALL YOUR THESIS API (THIS IS THE CORE FIX) ----
            with open(temp_file_path, "rb") as f:
                files = {
                    "file": (video_file.name, f, video_file.content_type)
                }

                data = {
                    "subject_id": "S01",
                    "condition": "rest",      # later you can make dynamic
                    "modality": "face",       # face or palm
